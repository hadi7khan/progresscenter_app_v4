...
class ProfileTeamScreen extends ConsumerStatefulWidget {
  ...
  final String? userId;
  const ProfileTeamScreen(
      {super.key, this.teamsList, this.selectedTeams, this.userId});

  @override
  ConsumerState<ProfileTeamScreen> createState() => _ProfileTeamScreenState();
}

class _ProfileTeamScreenState extends BaseConsumerState<ProfileTeamScreen> {
