...
class ViewedByWidget extends StatefulWidget {
  ...
  final projectId;
  final showExtra;
  const ViewedByWidget({super.key, this.data, this.showText, this.projectId, this.showExtra});
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return ListTile(
                    ...
                    subtitle: widget.showExtra ? Text(
                    ...
                    trailing:widget.showExtra ?  InkWell(
                        radius: 40,
                                    ...
                                    return FormBuilder(
                                      child: AlertDialog(
                                        ...
                                        actions: [
                                          TextButton(
                                            onPressed: () async {
                                              print("project user data "+widget.data.id.toString());
                                              Service()
                                                  .revokeMember(
                                                    widget.projectId,
                                                      widget.data.userId
                        ...
                        child: SvgPicture.asset(
                            width: 15,
                            height: 15,
                            'assets/images/close-x.svg', color: Helper.errorColor)) : SizedBox(),
                  );
                },
              ),
            ]),
