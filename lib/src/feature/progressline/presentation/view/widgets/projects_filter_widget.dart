...
class ProjectsFilterWidget extends StatefulWidget {
  ...
  const ProjectsFilterWidget(
      {super.key, required this.progresslineProjects, required this.onChange});
          ...
          itemBuilder: (context, index) {
            ...
            return InkWell(
              ...
              child: ListTile(
                ...
                leading: widget.progresslineProjects[index].coverImageUrl !=
                        null
                    ? ClipRRect(
                        ...
                        child: AspectRatio(
                          aspectRatio: 16 / 9,
                          child: Image.network(
                            widget.progresslineProjects[index].coverImageUrl,
                            fit: BoxFit.fill,
