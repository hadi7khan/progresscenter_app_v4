...
class _$_UserProfileModel implements _UserProfileModel {
  ...
  @override
  String toString() {
    return 'UserProfileModel(preset: $preset, id: $id, name: $name, username: $username, email: $email, role: $role, status: $status, dp: $dp, designation: $designation, tags: $tags, projects: $projects, lastActive: $lastActive, dpUrl: $dpUrl)';
  }
