...
class DroneFootageScreen extends StatefulWidget {
  final String projectId;
  const DroneFootageScreen({super.key, required this.projectId});

  @override
  State<DroneFootageScreen> createState() => _DroneFootageScreenState();
}

class _DroneFootageScreenState extends State<DroneFootageScreen> {
  @override
