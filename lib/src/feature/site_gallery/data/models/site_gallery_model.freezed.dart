...
SiteGalleryModel _$SiteGalleryModelFromJson(Map<String, dynamic> json) {
  return _SiteGalleryModel.fromJson(json);
}

/// @nodoc
mixin _$SiteGalleryModel {
  @JsonKey(name: "_id")
  ...
  @JsonKey(ignore: true)
  $SiteGalleryModelCopyWith<SiteGalleryModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $SiteGalleryModelCopyWith<$Res> {
  factory $SiteGalleryModelCopyWith(
          SiteGalleryModel value, $Res Function(SiteGalleryModel) then) =
      _$SiteGalleryModelCopyWithImpl<$Res, SiteGalleryModel>;
  @useResult
  $Res call(
...
/// @nodoc
class _$SiteGalleryModelCopyWithImpl<$Res, $Val extends SiteGalleryModel>
    implements $SiteGalleryModelCopyWith<$Res> {
  _$SiteGalleryModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$_SiteGalleryModelCopyWith<$Res>
    implements $SiteGalleryModelCopyWith<$Res> {
  factory _$$_SiteGalleryModelCopyWith(
          _$_SiteGalleryModel value, $Res Function(_$_SiteGalleryModel) then) =
      __$$_SiteGalleryModelCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "_id") String? id,
...
/// @nodoc
class __$$_SiteGalleryModelCopyWithImpl<$Res>
    extends _$SiteGalleryModelCopyWithImpl<$Res, _$_SiteGalleryModel>
    implements _$$_SiteGalleryModelCopyWith<$Res> {
  __$$_SiteGalleryModelCopyWithImpl(
      _$_SiteGalleryModel _value, $Res Function(_$_SiteGalleryModel) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_SiteGalleryModel(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
@JsonSerializable()
class _$_SiteGalleryModel implements _SiteGalleryModel {
  ...
  factory _$_SiteGalleryModel.fromJson(Map<String, dynamic> json) =>
      _$$_SiteGalleryModelFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_SiteGalleryModelCopyWith<_$_SiteGalleryModel> get copyWith =>
      __$$_SiteGalleryModelCopyWithImpl<_$_SiteGalleryModel>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_SiteGalleryModelToJson(
      this,
    );
  }
}

abstract class _SiteGalleryModel implements SiteGalleryModel {
  ...
  factory _SiteGalleryModel.fromJson(Map<String, dynamic> json) =
      _$_SiteGalleryModel.fromJson;
